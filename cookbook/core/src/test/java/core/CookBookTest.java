...
public class CookBookTest {
  ...
  public void setUp() {
    ...
    recipeList.add(
        new Recipe("Recipe1", Arrays.asList(new Ingredient("Ingredient1", 10, "g")), "Appetizer"));
    recipeList.add(
        new Recipe("Recipe2", Arrays.asList(new Ingredient("Ingredient2", 20, "g")), "Dinner"));
  ...
  public void testSetRecipiesSizeCheck() {
    cookBook.setRecipes(Arrays.asList(
        new Recipe("Recipe2", Arrays.asList(new Ingredient("Ingredient2", 20, "g")), "Dinner")));
  ...
  public void testAddExistingRecipe() {
    assertThrows(IllegalArgumentException.class, () -> cookBook.addRecipe(
        new Recipe("Recipe1", Arrays.asList(new Ingredient("Ingredient1", 10, "g")), "Appetizer")));
  }
  ...
  public void testAddRecipieSizeCheck() {
    ...
    cookBook.addRecipe(
        new Recipe("Recipe3", Arrays.asList(new Ingredient("Ingredient2", 20, "g")), "Dinner"));
  ...
  public void testToString() {
    String expected =
        "CookBook [recipes="
        + "[Recipe1, [Ingredient1, 10.0, g], Appetizer, Recipe2, [Ingredient2, 20.0, g], Dinner]]";
  ...
  public void testgetCookBookByIngredientSearch() {
    assertEquals(cookBook.getRecipes().get(0),
        cookBook
            .getCookBookByIngredientSearch(Arrays.asList(new Ingredient("Ingredient1", 20, "g")))
            .get(0));

    assertThrows(IllegalArgumentException.class, () -> cookBook
        .getCookBookByIngredientSearch(Arrays.asList(new Ingredient("Ingredient1", 5, "g"))));
